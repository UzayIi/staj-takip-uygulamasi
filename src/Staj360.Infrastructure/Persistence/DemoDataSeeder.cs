...
public static class DemoDataSeeder
{
    ...
    public static async Task SeedAsync(IServiceProvider services, bool isDevelopment, CancellationToken cancellationToken = default)
    {
        ...
        var interns = new[]
        {
            new DemoIntern("Ayşe Yılmaz", "ayse.yilmaz@staj360.local", "DEMO-1001", "Fırat Üniversitesi", "Yazılım Mühendisliği", "Bilgi İşlem Daire Başkanlığı", mentorSelin.Id),
            new DemoIntern("Mehmet Kaya", "mehmet.kaya@staj360.local", "DEMO-1002", "Dicle Üniversitesi", "Bilgisayar Mühendisliği", "İnsan Kaynakları ve Eğitim Daire Başkanlığı", mentorSelin.Id),
            new DemoIntern("Zeynep Demir", "zeynep.demir@staj360.local", "DEMO-1003", "Fırat Üniversitesi", "Yapay Zekâ ve Veri Mühendisliği", "Fen İşleri Daire Başkanlığı", mentorMurat.Id),
            new DemoIntern("Emir Arslan", "emir.arslan@staj360.local", "DEMO-1004", "İnönü Üniversitesi", "Bilgisayar Mühendisliği", "Ulaşım Daire Başkanlığı", mentorSelin.Id),
            new DemoIntern("Elif Şahin", "elif.sahin@staj360.local", "DEMO-1005", "Dicle Üniversitesi", "Yönetim Bilişim Sistemleri", "Çevre Koruma ve Kontrol Daire Başkanlığı", mentorMurat.Id),
            new DemoIntern("Can Aydın", "can.aydin@staj360.local", "DEMO-1006", "Fırat Üniversitesi", "Yazılım Mühendisliği", "Mali Hizmetler Daire Başkanlığı", mentorMurat.Id),
            new DemoIntern("Ali Veli", "ali.veli@staj360.local", "DEMO-1007", "Boğaziçi Üniversitesi", "İnşaat Mühendisliği", "İmar ve Şehircilik Daire Başkanlığı", mentorSelin.Id),
            new DemoIntern("Ayşe Fatma", "ayse.fatma@staj360.local", "DEMO-1008", "ODTÜ", "Çevre Mühendisliği", "Park ve Bahçeler Daire Başkanlığı", mentorMurat.Id),
            new DemoIntern("Burak Tekin", "burak.tekin@staj360.local", "DEMO-1009", "Ankara Üniversitesi", "Yazılım Mühendisliği", "Bilgi İşlem Daire Başkanlığı", mentorSelin.Id),
            new DemoIntern("Ceren Yılmaz", "ceren.yilmaz@staj360.local", "DEMO-1010", "Gazi Üniversitesi", "Endüstri Mühendisliği", "İnsan Kaynakları ve Eğitim Daire Başkanlığı", mentorMurat.Id),
            new DemoIntern("Deniz Çelik", "deniz.celik@staj360.local", "DEMO-1011", "Hacettepe Üniversitesi", "Bilgisayar Mühendisliği", "Ulaşım Daire Başkanlığı", mentorSelin.Id),
            new DemoIntern("Eren Korkmaz", "eren.korkmaz@staj360.local", "DEMO-1012", "İTÜ", "Makine Mühendisliği", "Fen İşleri Daire Başkanlığı", mentorMurat.Id),
            new DemoIntern("Furkan Öztürk", "furkan.ozturk@staj360.local", "DEMO-1013", "Yıldız Teknik Üniversitesi", "Yazılım Mühendisliği", "Mali Hizmetler Daire Başkanlığı", mentorSelin.Id)
        };
        ...
        foreach (var spec in interns)
        {
            ...
            var profile = await db.InternProfiles.IgnoreQueryFilters().FirstOrDefaultAsync(p => p.UserId == user.Id, cancellationToken);
            if (profile is null)
            {
    ...
    private static async Task<Dictionary<string, Department>> EnsureDepartmentsAsync(AppDbContext db, CancellationToken cancellationToken)
    {
        var names = new[]
        {
            ("Bilgi İşlem Daire Başkanlığı", "Kurumsal bilişim altyapısı, yazılım geliştirme ve siber güvenlik"),
            ("İnsan Kaynakları ve Eğitim Daire Başkanlığı", "Personel yönetimi, stajyer koordinasyonu ve kurum içi eğitimler"),
            ("Fen İşleri Daire Başkanlığı", "Altyapı, üstyapı, yol ve köprü projeleri"),
            ("İmar ve Şehircilik Daire Başkanlığı", "İmar planları, yapı ruhsatları ve kentsel dönüşüm"),
            ("Ulaşım Daire Başkanlığı", "Toplu taşıma, trafik düzenlemesi ve ulaşım planlaması"),
            ("Park ve Bahçeler Daire Başkanlığı", "Yeşil alan düzenlemesi, park bakımı ve peyzaj projeleri"),
            ("Çevre Koruma ve Kontrol Daire Başkanlığı", "Çevre denetimi, atık yönetimi ve sürdürülebilirlik"),
            ("Kültür ve Sosyal İşler Daire Başkanlığı", "Kültürel etkinlikler, sosyal yardımlar ve toplum hizmetleri"),
            ("Mali Hizmetler Daire Başkanlığı", "Bütçe yönetimi, muhasebe ve mali raporlama"),
            ("Hukuk Müşavirliği", "Hukuki danışmanlık, dava takibi ve mevzuat uyumu"),
            ("Basın Yayın ve Halkla İlişkiler Daire Başkanlığı", "Kurumsal iletişim, medya ilişkileri ve halkla ilişkiler"),
            ("Destek Hizmetleri Daire Başkanlığı", "Lojistik, satın alma ve idari destek hizmetleri")
        };
        ...
        CancellationToken cancellationToken)
    {
        var p1 = await EnsureProjectAsync(db, "Kurumsal Talep Yönetim Sistemi",
            ...
            departments["Bilgi İşlem Daire Başkanlığı"].Id, mentorSelinId, ProjectStatus.InProgress, 45, cancellationToken);
        var p2 = await EnsureProjectAsync(db, "Veri Analizi ve Raporlama Paneli",
            "Staj ve operasyon verilerini özetleyen yönetim paneli.",
            departments["İnsan Kaynakları ve Eğitim Daire Başkanlığı"].Id, mentorMuratId, ProjectStatus.InProgress, 30, cancellationToken);
