...
public class InternshipPeriodsController : Controller
{
    ...
    public async Task<IActionResult> Index(int page = 1, CancellationToken cancellationToken = default)
    {
        ...
        var internsResult = await _internService.ListAsync(null, null, null, null, 1, 1000, cancellationToken);
    ...
    {
        var interns = await _internService.ListAsync(null, null, null, null, 1, 200, cancellationToken);
