...
public class AttendanceServiceTests
{
    ...
    public async Task CheckOut_OnNewDbContext_AfterCheckIn_Succeeds()
    {
        ...
        try
        {
            ...
            var dep = new Staj360.Domain.Entities.Department { Name = "Yazılım", IsActive = true };
            ...
            var profile = new Staj360.Domain.Entities.InternProfile { UserId = userId, StudentNumber = "9", Department = dep, IsActive = true };
            ...
            db1.AddRange(dep, schedule, profile, period);
